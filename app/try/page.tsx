...
import { useAppState, usePageOperations, useHistoryOperations, useComponentOperations } from "@/lib/store/hooks"
...
export default function BuilderPage() {
  ...
  const currentPage = state.componentTree.find((page) => page.id === state.activePage) || state.componentTree[0]
